...
import { comShow,comChange } from '../../features/actions/companieAction';
...
const FormControl = () => {
  ...
  const pushChange = (e) => {
      ...
      dispatch(comChange({"body":postData}));
    };
  return (
    <CRow>
      {isShowLoading ?
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          <CCardHeader>
            <strong>Edit {dataShow && dataShow.company_name}</strong>
          </CCardHeader>
          <CCardBody>
            {dataShow ?
              ...
              <CRow>
                <CCol xs={4}>
                  <CFormInput
                      ...
                      defaultValue={dataShow.company_name}
                ...
                <CCol xs={8}>
                  <CFormInput
                      ...
                      defaultValue={dataShow.company_address}
