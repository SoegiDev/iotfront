...
import { importOutlet,cancelImportStore,saveImportStore } from '../../features/actions/importAction';
...
const FormControl = () => {
  ...
  const onFileUpload = () => {
    ...
    dispatch(importOutlet(formData))
  };
  const cancelSave = (e) => {
    e.preventDefault();
    ...
    // dispatch(outletChange({"body":postData}));
  };
  ...
  const SubmitSave = (e) => {
    ...
    setSaveImport(true)
    dispatch(saveImportStore({"company_id":rootCompany,"file_xls":fileXls,"file_json":fileJson}));
  };
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <CRow>
              ...
              <CCol sm={6} md={6}>
                <div className="mb-3">
                    <CFormLabel htmlFor="formFileSm">Import Outlet (File : .xlsx)</CFormLabel>
                    <CFormInput type="file" size="sm" id="outletUpload" ref={fileInputRef}
                    name="file"
            ...
            <CRow>
              <CCol xs={12}>
                ...
                <CRow>
                  <CCol xs={6}>
                    <strong>
                    Total Data Import Outlet: {dataImport.length}
                    </strong>
                  </CCol>
                  <CCol xs={6} align="end">
