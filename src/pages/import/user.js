...
import { importUser,cancelImportStore,saveImportUser } from '../../features/actions/importAction';
...
const FormControl = () => {
  ...
  const SubmitSave = (e) => {
    ...
    setSaveImport(true)
    dispatch(saveImportUser({"company_id":rootCompany,"file_xls":fileXls,"file_json":fileJson}));
  };
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <CRow>
              ...
              <CCol sm={6} md={6}>
                <div className="mb-3">
                    <CFormLabel htmlFor="formFileSm">Import User (File : .xlsx)</CFormLabel>
                    <CFormInput type="file" size="sm" id="userUpload" ref={fileInputRef}
                    name="file"
            ...
            <CRow>
              <CCol xs={12}>
                ...
                <CRow>
                  <CCol xs={6}>
                    <strong>
                    Total Data Import User: {dataImport.length}
                    </strong>
                  </CCol>
                  <CCol xs={6} align="end">
