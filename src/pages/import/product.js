...
import { importProduct,cancelImportStore,saveImportProduct } from '../../features/actions/importAction';
...
const FormControl = () => {
  ...
  const SubmitSave = (e) => {
    ...
    setSaveImport(true)
    dispatch(saveImportProduct({"company_id":rootCompany,"file_xls":fileXls,"file_json":fileJson}));
  };
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <CRow>
              ...
              <CCol sm={6} md={6}>
                <div className="mb-3">
                    <CFormLabel htmlFor="formFileSm">Import Product (File : .xlsx)</CFormLabel>
