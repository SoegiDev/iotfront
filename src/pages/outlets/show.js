...
import { outletShow,outletChange } from '../../features/actions/outletAction';
...
const FormControl = () => {
  ...
  useEffect(() =>{
    if (showData === null){
    dispatch(outletShow({"body":{"id":id,"company_id":company_id}}))
    }
  },[showData,dispatch]);
  useEffect(() =>{
      if(!isShowLoading){
              ...
              <CRow>
                ...
                <CCol sm={6} md={4}>
                  <CFormInput
                      ...
                      defaultValue={dataShow.store_email}
